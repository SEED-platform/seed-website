...
??? note "Connecting your SEED organization to Audit Template"
    ...
    1. Request an Audit Template Account at <https://buildingenergyscore.energy.gov/>
      a. Work with the Audit Template team to configure a customized Report Template for your jurisdiction.
    1. Configure the Audit Template connection in SEED settings.
    ...
    1. If desired, set automatic update cadence in SEED settings.
    1. Save changes to finalize API connection and update schedule.
    1. After entering the information above into SEED settings, import submissions to update SEED records with Audit Template records.
